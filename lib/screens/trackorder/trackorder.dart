...
class _TrackOrderScreenState extends State<TrackOrderScreen> {
  ...
  final List<Map<String, dynamic>> _statusData = [
    {'status': 'Order Placed', 'time': '2:30 PM', 'completed': true, 'icon': Icons.shopping_bag_outlined},
    {'status': 'Preparing', 'time': '2:35 PM', 'completed': true, 'icon': Icons.restaurant_outlined},
    {'status': 'Out for Delivery', 'time': '2:45 PM', 'completed': true, 'icon': Icons.delivery_dining_outlined},
    {'status': 'Delivered', 'time': '3:00 PM', 'completed': false, 'icon': Icons.home_outlined},
  ];

  final List<Map<String, dynamic>> _orderDetails = [ // Changed to dynamic
    {'label': 'Order ID', 'value': '#FD-789456', 'icon': Icons.receipt_long_outlined},
    {'label': 'Restaurant', 'value': 'Gourmet Kitchen', 'icon': Icons.storefront_outlined},
    {'label': 'Items', 'value': 'Pasta Carbonara, Quinoa Salad', 'icon': Icons.fastfood_outlined},
    {'label': 'Total Amount', 'value': '\$45.99', 'icon': Icons.attach_money_outlined},
    {'label': 'Payment', 'value': '•••• 4242', 'icon': Icons.credit_card_outlined},
    {'label': 'Delivery Address', 'value': '123 Main St, San Francisco', 'icon': Icons.location_on_outlined},
    {'label': 'ETA', 'value': '8 minutes', 'icon': Icons.timer_outlined},
    {'label': 'Delivery Agent', 'value': 'John Doe', 'icon': Icons.person_outline, 'rating': '4.9 ⭐'},
  ];
          ...
          Stack(
            children: [
              ...
              AnimatedContainer(
                ...
                height: 8,
                width: MediaQuery.of(context).size.width * 0.85 * _deliveryProgress,
                decoration: BoxDecoration(
              ...
              child: Column(
                children: [
                  _buildMapControlButton(
                    ...
                    onTap: () {
                      _mapController?.animateCamera(
                        CameraUpdate.newLatLng(const LatLng(37.7917, -122.3992)),
                      );
                    },
                  ),
                  const SizedBox(height: 8),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 24),
          ..._orderDetails.map((detail) => _buildDetailItem(
