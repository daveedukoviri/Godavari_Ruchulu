                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              Expanded(
                                child: Text(
                                  'Your Choice Of Burger (Choose 1)',
                              ...
                              Expanded(
                                child: OutlinedButton(
                                  ...
                                  style: OutlinedButton.styleFrom(
                                    ...
                                    padding: const EdgeInsets.symmetric(
                                      vertical: 12,
                                    ), // Matches your previous height
                                    shape: RoundedRectangleBorder(
                                      borderRadius: BorderRadius.circular(30),
                                    ),
                                    side: BorderSide
                                        .none, // Removes the default outline border
                                    elevation:
                                        0, // Not needed for OutlinedButton, but safe
                                  ),
                                  child: const Text(
                                    'Add To Cart',
                                    style: TextStyle(
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            ...
            Text(price, style: TextStyle(color: AppTheme.gray, fontSize: 16)),
          ],
        ),
      ),
    );
